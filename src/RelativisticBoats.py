...
def display(screen, clicked, justClicked, v, font1, font2, font3, font4, input, toggleT, blinkTime, tx, switchScreen, play, lorentzC):
...
while running:
    ...
    display(screen, clicked, justClicked, v, font1, font2, font3, font4, input, toggleT, blinkTime, tx, switchScreen, play, lorentzC)
    dt = getdt(v)
